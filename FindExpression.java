...
/** 返回可得出所需结果的符合条件的表达式 */
	public String[] getExpression() {
		if (!error) {
			...
			int n=0,max=(expression.length-1)/maxLine+1;
...
/** cal24()，输出结果为24的表达式 */
	public String[] calculate(double[] n) {
		...
		String[] resultString=new String[100]	; //最多100组解,暂时未溢出
		int count=0;
				...
				for (int t2=0; t2<3; t2++) {
					for (int c2=0; c2<6; c2++) {
						for (int c3=0; c3<6; c3++) {
							if ((c1/3==c2/3 && (c1%3)*(c2%3)!=0)||(c2/3==c3/3 && (c2%3)*(c3%3)!=0)||(c1/3==c3/3 && (c1%3)*(c3%3)!=0 && t2==2)) {	//去除连减连除的解,因为x/(y/z)=x*z/y
								continue;
							}
							n1=cal1(n,t1,c1);
							n2=cal2(n1,t2,c2);
		...
		System.out.println(resultString[count]);
		return resultReturn;
	}
